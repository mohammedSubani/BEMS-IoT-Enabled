...
File Name: DataAcquisition-2.ino
...
/*Defining web server object like struct using port 5007*/
ESP8266WebServer server(5007);

/*Defining adafruit sensors object like structs (TSL2561)*/
...
/* In case of failing connection DHT readings will read not a number value (nan)*/
 ...
 // Sending notifying message for sucessful connection.(development)
...
/*==========================================================*/
  ...
  /*Motion loop state is detected every 30000 loop*/
...
/*==========================================================*/
  ...
  {
    //Serial.println("Didn't recieve a light event due overloadding .... completing the loop"); // Uncomment for debugging
  }
...
@Returns: void
*/
void call_handle()     {server.send(200, "text/plain", string_toSend());}
...
String string_toSend()
{
  ...
  ptr+= "\n \"co2\":"; 
  ptr+= "\"No CO2 Reading\""; //NO CO2 reading
  ptr+= " ,";
